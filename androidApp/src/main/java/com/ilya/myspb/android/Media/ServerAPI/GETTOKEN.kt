...
fun sendNotificationToCloud(): Formattoken {
    ...
    val request = Request.Builder()
        ...
        .addHeader("Authorization", "Basic N2NhMGM3NzAtMGFmMi00NGQwLWEyNGMtNDI1ZDRjZTMzODhhOjA0NmZkNDYwLTYxOTUtNDk4NS05NDEwLWZmYThhODExNTkxYw==") // Замените на ваш ключ авторизации
        .post(formBody)
        .build()
